    ...
    return (
        <section className="todos-list">
            ...
            <div className="todo-list">
                ...
                { state.tasks.length > 0 ? state.tasks.map( (item) => <TodoItem key={item.id} task={item} setItemState={setItemState} status={item.active} /> ) : (<div className="todo"> There are no items, yet! </div>) }
            </div>
