        ...
        <section className="main-logo">
            <svg width="100px" height="100px" viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                ...
                <linearGradient x1="34.9523037%" y1="0%" x2="116.039609%" y2="115.484477%" id="linearGradient-1">
                    <stop stopColor="#27FDC7" offset="0%"></stop>
                    <stop stopColor="#0FC0F5" offset="100%"></stop>
                </linearGradient>
                ...
                <linearGradient x1="0%" y1="0%" x2="115.291753%" y2="112.548614%" id="linearGradient-4">
                    <stop stopColor="#27FDC7" offset="0%"></stop>
                    <stop stopColor="#0FC0F5" offset="83.2001616%"></stop>
                    <stop stopColor="#27FDC7" offset="100%"></stop>
                </linearGradient>
